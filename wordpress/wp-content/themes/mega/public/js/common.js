	...
	mobileMenu: function mobileMenu() {
		...
		_this.menuMobileLink.forEach(function (element) {
			element.addEventListener('click', function (e) {
				console.log(element); // _this.closeMenu(); 
			});
		});
...
function eventHandler() {
	...
	$('.s-partners__slider--js').slick(_objectSpread({}, defaultSlide, {
		arrows: false,
		rows: 2,
		slidesToShow: 1,
		slidesToScroll: 1,
	...
	$(".wpcf7").on('wpcf7:mailsent', function (event) {
		...
		$("div.wpcf7-mail-sent-ok").hide(); // ym(55556008, 'reachGoal', 'order', goalParams); 
